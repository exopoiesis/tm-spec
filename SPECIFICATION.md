...
The current specification is **TM-Spec v0.2** (draft, 2026-05-10).

- **Current versioned text:** [`docs/specification/v0.2.md`](docs/specification/v0.2.md)
- **Current JSON Schema:** [`schemas/0.2.json`](schemas/0.2.json)
...
`spec:` field, e.g. `spec: tm-spec/0.2`. Validators MUST select the
